        ...
        <form action="{{ route('admin.categorias.update', $categoria->id) }}" method="POST">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <flux:input name="nombre" id="nombre" type="text" icon="tag" placeholder="Ej. Lácteos, Bebidas, Abarrotes..." value="{{ old('nombre', $categoria->nombre) }}" required />
                    @error('nombre')
...
</x-layouts::app><x-layouts::app title="Editar Categoría">
    <div class="relative mb-6 w-full">
        <flux:heading size="xl" level="1">Editar Categoría: {{ $categoria->nombre }}</flux:heading>
        <br>
        <flux:separator variant="subtle" />
